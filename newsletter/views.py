...
from newsletter.services import get_recipients_from_cache, get_newsletters_from_cache, get_messages_from_cache, \
...
class FinishNewsletterView(LoginRequiredMixin, View):
